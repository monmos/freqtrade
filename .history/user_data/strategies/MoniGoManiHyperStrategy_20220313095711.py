...
class MoniGoManiHyperStrategy(MasterMoniGoManiHyperStrategy):
    ...
    def do_populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        buy_dataframe_long = resample_to_interval(dataframe, 30*self.buy_cdldragonflydoji_length.value)
        ...
        dataframe["cdldragonflydoji"]=cdldragonflydoji[f'resample_{30*self.buy_cdldragonflydoji_length.value}_cdldragonflydoji']
        buy_dataframe_long = resample_to_interval(dataframe, 30*self.buy_cdlpiercing_length.value)
        ...
        dataframe["cdlpiercing"]=cdlpiercing[f'resample_{30*self.buy_cdlpiercing_length.value}_cdlpiercing']
        buy_dataframe_long = resample_to_interval(dataframe, 30*self.buy_cdlmorningstar_length.value)
        ...
        dataframe["cdlmorningstar"]=cdlmorningstar[f'resample_{30*self.buy_cdlmorningstar_length.value}_cdlmorningstar']
        # buy_dataframe_long = resample_to_interval(dataframe, 30*self.buy_cdl3whitesoldiers_length.value)
        ...
        # dataframe["cdl3whitesoldiers"]=cdl3whitesoldiers[f'resample_{30*self.buy_cdl3whitesoldiers_length.value}_cdl3whitesoldiers']
