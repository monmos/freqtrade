...
class MoniGoManiHyperStrategy(MasterMoniGoManiHyperStrategy):
    ...
    sell_under_ma_period = IntParameter(low=10, high=100, default=9, space="sell")
    ...
    def do_populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["buy_under_ma"]=buy_under_ma_df.max(axis="high")
        ...
        # buy_dataframe_long = resample_to_interval(dataframe, 60*self.buy_cdlinvertedhammer_length.value)
        ...
        # dataframe["cdlinvertedhammer"]=cdlinvertedhammer[f'resample_{60*self.buy_cdlinvertedhammer_length.value}_cdlinvertedhammer']
        ...
        dataframe["sell_ma2"] = ta.MA(dataframe,timeperiod=self.sell_ma3_period.value,matype=self.sell_ma2_type.value)
        ...
        dataframe["sell=upper_ma"]=sell_upper_ma_df.max(axis="high")
