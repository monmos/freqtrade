...
class MoniGoManiHyperStrategy(MasterMoniGoManiHyperStrategy):
    ...
    def do_populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # buy_dataframe_long = resample_to_interval(dataframe, 60*self.buy_cdlhammer_length.value)
        ...
        # dataframe["cdlhammer"]=cdlhammer[f'resample_{60*self.buy_cdlhammer_length.value}_cdlhammer']
        ...
        dataframe["sell_ma1"] = ta.MA(dataframe,timeperiod=self.sell_ma2_period.value,matype=self.sell_ma2_type.value)
